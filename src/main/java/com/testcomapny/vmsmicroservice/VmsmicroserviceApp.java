...
public class VmsmicroserviceApp {

    private static final Logger log = LoggerFactory.getLogger(VmsmicroserviceApp.class);

    private final Environment env;

    public VmsmicroserviceApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes vmsmicroservice.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(VmsmicroserviceApp.class);
